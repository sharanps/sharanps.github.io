    ...
    <div class="wrapper">
        ...
        <div class="content">
			...
			<?php require_once __DIR__ . '/php/recaptcha/autoload.php';				
				$siteKey = '6LczpRMUAAAAAPoNIMfKBfxAfUzS4qw5rA67NyK6'; // visit https://www.google.com/recaptcha/admin to generate keys
				$secret = '6LczpRMUAAAAAJtvpiS_OqrbHKjnz9X9LV_UMMfk';
